  ...
  return (
    <div className="home-container">
      <Helmet>
        ...
        <meta property="og:title" content="chartwise" />
      ...
      <div className="home-video">
        ...
        <TextField id="filled-basic" label="Enter ticker name" variant="filled" style={{backgroundColor: '#FFFFFF', width: 350}}/>
          <div className="home-content0101" style={{flexDirection: 'column'}}>
            <p>Select start date</p>
        <DatePicker selected={startDate1} onChange={(date) => setStartDate1(date)} />
        </div>
        <div className="home-content0102" style={{flexDirection: 'column'}}>
          <p>Select end date</p>
        ...
        <TextField
          id="filled-select-patterntype"
          select
          label="Select pattern"
          defaultValue="Triangle pattern"
          variant="filled"
        ...
        <Button variant="contained" style={{marginTop: 40, marginRight: 20}}>Submit</Button>
      </div>
      ...
      <div className="home-sections">
        <div className="home-section">
          ...
          <div className="home-content02">
            <h2 className="home-text005">Everything you get with Chartwise</h2>
            ...
            <div className="home-accordion">
              ...
              >
                <div className="home-details">
                  ...
                  <span data-role="accordion-content" className="home-text020">
              ...
              >
                <div className="home-details1">
                  ...
                  <span data-role="accordion-content" className="home-text022">
              ...
              >
                <div className="home-details2">
                  <span className="home-text023">Sharp - Insight rich</span>
...
`}
        ...
        <div className="home-banner">
          <div className="home-overlay">
            ...
            <div className="home-book-btn">
              <span className="home-text026">Book a demo</span>
            </div>
          </div>
          <img
            alt="pastedImage"
      ...
      <div className="home-features">
        <div className="home-header1">
          <div className="home-tag">
            <span className="home-text027">Features</span>
          </div>
          <div className="home-heading02">
            <h2 className="home-text028">Everything you get with Chartwise</h2>
      ...
      <div className="home-pricing">
        <div className="home-content14">
          <div className="home-header2">
            <div className="home-tag1">
              <span className="home-text034">Pricing plans</span>
            </div>
            <div className="home-heading03">
              <h2 className="home-text035">No setup cost or hidden fees.</h2>
            </div>
          </div>
                ...
                <div className="home-bottom">
                  <div className="home-check-list">
                    ...
                    <div className="home-check05">
                      ...
                      <span className="home-text041">Interactive charts</span>
                    </div>
                  ...
                  <div className="home-button">
                    <span className="home-text044">Get Standard</span>
                  </div>
                </div>
              </div>
              <div className="home-plan1">
                <div className="home-top1">
                  <div className="home-heading05">
                    <span className="home-text045">Plus</span>
                    <span className="home-text046">
                      Analyze upto 50 stocks through various patterns
                    </span>
                  </div>
                  <div className="home-cost1">
                    <span className="home-text047">$8</span>
                    <span className="home-text048">/month</span>
                  </div>
                </div>
                <div className="home-bottom1">
                  <div className="home-check-list1">
                    <div className="home-check08">
                      ...
                      <span className="home-text049">Live demo to analyze</span>
                    </div>
                  ...
                  <div className="home-button1">
                    <span className="home-text054">Get Standard</span>
                  </div>
                </div>
              </div>
                ...
                <div className="home-bottom2">
                  <div className="home-check-list2">
                    ...
                    <div className="home-check15">
                      ...
                      <span className="home-text061">Get indepth analysis</span>
                    </div>
                  ...
                  <div className="home-button2">
                    <span className="home-text064">Get Standard</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="home-overlay1">
                <div className="home-header3">
                  <div className="home-heading07">
                    <span className="home-text065">Expand</span>
            ...
            <div className="home-plan3">
              <div className="home-top3">
                <div className="home-heading08">
                  <span className="home-text073">Standard</span>
                  <span className="home-text074">
                    Sed ut perspiciatis unde omnis iste natus error sit.
                  </span>
                </div>
                <div className="home-cost3">
                  <span className="home-text075">Free</span>
                </div>
              </div>
              <div className="home-bottom3">
                ...
                <div className="home-button4">
                  <span className="home-text076">Get Standard</span>
                </div>
              </div>
            </div>
            <div className="home-plan4">
              <div className="home-top4">
                <div className="home-heading09">
                  <span className="home-text077">Plus</span>
                  <span className="home-text078">
                    Sed ut perspiciatis unde omnis iste natus error sit.
                  </span>
                </div>
                <div className="home-cost4">
                  <span className="home-text079">$8</span>
                  <span className="home-text080">/month</span>
                </div>
              </div>
              <div className="home-bottom4">
                ...
                <div className="home-button5">
                  <span className="home-text081">Get Plus</span>
                </div>
              </div>
            </div>
            <div className="home-plan5">
              <div className="home-top5">
                <div className="home-heading10">
                  <span className="home-text082">Premium</span>
                  <span className="home-text083">
                    Sed ut perspiciatis unde omnis iste natus error sit.
                  </span>
                </div>
                <div className="home-cost5">
                  <span className="home-text084">$16</span>
              ...
              <div className="home-bottom5">
                ...
                <div className="home-button6">
                  <span className="home-text086">Get Plus</span>
                </div>
              </div>
            </div>
              ...
              <div className="home-overlay2">
                <div className="home-header4">
                  <div className="home-heading11">
                    <span className="home-text087">Expand</span>
        ...
        <div className="home-help">
          <span className="home-text095">Need any help?</span>
        ...
        <div className="home-content15">
          <div id="quotes" className="home-quotes">
            <div className="quote active-quote">
              <div className="home-quote01">
                <div className="home-quote02">
                  <span className="home-quote03">
                    “Best Stock chart pattern analyzer in the market. I love its
                    easy to use interface and its accurate and reliable results.
                ...
                <div className="home-people">
                  <div className="home-person">
                    <img
                      alt="person-avatar"
                      src="/playground_assets/pastedimage-8jmb-200w.png"
                      className="home-avatar"
                    />
                    <div className="home-person-details">
                      <span className="home-text097">Ria Sharma</span>
                      <span>Manager @Vista Social</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="quote">
              <div className="home-quote05">
                <div className="home-quote06">
                  <span className="home-quote07">
                    &quot;Hands down the most easy to use.&quot;
                  </span>
                </div>
                <div className="home-people1">
                  <div className="home-person1">
                    <img
                      alt="person-avatar"
                      src="/playground_assets/test2-200h.png"
                      className="home-avatar1"
                    />
                    <div className="home-person-details1">
                      <span className="home-text099">Mahesh Ranjane</span>
                      <span>Developer @ Vista La Vista</span>
                    </div>
                  </div>
                </div>
              </div>
            </div>
            <div className="home-quote08 quote">
              <div className="home-quote09">
                <div className="home-quote10">
                  <span className="home-quote11">
                    &quot;One of the most reliable.&quot;
                  </span>
                </div>
                <div className="home-people2">
                  <div className="home-person2">
                    <img
                      alt="person-avatar"
                      src="/playground_assets/test1-200w.png"
                      className="home-avatar2"
                    />
                    <div className="home-person-details2">
                      <span className="home-text101">Vicky Singh</span>
                      <span>Designer @ OhBoy</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="home-content16">
          <div className="home-header5">
            ...
            <div className="home-heading12">
              <h2 className="home-text106">Frequently Asked Questions</h2>
            </div>
          </div>
      ...
      <div className="home-get-started1">
        <div className="home-content17">
          <div className="home-heading13">
            <h2 className="home-text107">Get started with Chartwise now!</h2>
